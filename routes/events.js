...
let eventsQuery = fs.readFileSync(path.join(__dirname, "../db/events_db/select_events.sql"), "utf-8");
...
let event_locations_query = fs.readFileSync(path.join(__dirname, "../db/events_db/select_event_locations.sql"), "utf-8");
let event_types_query = fs.readFileSync(path.join(__dirname, "../db/events_db/select_event_types.sql"), "utf-8");
...
let singleEventQuery = fs.readFileSync(path.join(__dirname, "../db/events_db/select_event_single.sql"), "utf-8");
...
let singleEventForFormQuery = fs.readFileSync(path.join(__dirname, "../db/events_db/select_event_single_form.sql"), "utf-8");
...
let insertEventQuery = fs.readFileSync(path.join(__dirname, "../db/events_db/insert_event.sql"), "utf-8");
...
let updateEventQuery = fs.readFileSync(path.join(__dirname, "../db/events_db/update_event.sql"), "utf-8"); 
